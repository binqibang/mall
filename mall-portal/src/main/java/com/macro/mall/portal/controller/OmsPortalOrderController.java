...
public class OmsPortalOrderController {
    ...
    @ResponseBody
    public CommonResult<Integer> cancelOrder(Long orderId) {
    ...
    @ResponseBody
    public CommonResult<Integer> cancelUserOrder(Long orderId) {
    ...
    @ResponseBody
    public CommonResult<Integer> confirmReceiveOrder(Long orderId) {
    ...
    @ResponseBody
    public CommonResult<Integer> deleteOrder(Long orderId) {
